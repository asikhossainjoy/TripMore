...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bookBtnSS;
        bookBtnSS=findViewById(R.id.bookBtn);
        bookBtnSS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //oo
                Intent intent2 = new Intent(DetailsActivity.this, Payment.class);
                Intent intent=getIntent();
                String email=intent.getStringExtra("email");
                /*String email="as";*/

                String packageName="Cox' Bazar, Bangladesh";
                String availableFlight="21 September, 2023";
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent2 = new Intent(DetailsActivity.this, Explore.class);
                Intent intent=getIntent();
                String email=intent.getStringExtra("email");
