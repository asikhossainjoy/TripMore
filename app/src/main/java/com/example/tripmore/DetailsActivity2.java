...
public class DetailsActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bookBtnSS;
        bookBtnSS=findViewById(R.id.bookBtn2);
        bookBtnSS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //oo
                Intent intent2 = new Intent(DetailsActivity2.this, Payment.class);
                Intent intent=getIntent();
                String email=intent.getStringExtra("email");
                /*String email="as";*/

                String packageName="Bandarban, Bangladesh";
                String availableFlight="11 December, 2023";
        ...
        imageButton2= (ImageView) findViewById(R.id.back2);
        imageButton2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent2 = new Intent(DetailsActivity2.this, Explore.class);
                Intent intent=getIntent();
                String email=intent.getStringExtra("email");
