...
public class DetailsActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bookBtnSS;
        bookBtnSS=findViewById(R.id.bookBtn5);
        bookBtnSS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //oo
                Intent intent2 = new Intent(DetailsActivity5.this, Payment.class);
                Intent intent=getIntent();
                String email=intent.getStringExtra("email");
                /*String email="as";*/

                String packageName="Sundarban Forest, Bangladesh";
                String availableFlight="31 December, 2023";
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent2 = new Intent(DetailsActivity5.this, Explore.class);
                Intent intent=getIntent();
                String email=intent.getStringExtra("email");
